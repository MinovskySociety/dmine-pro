...
#ifdef USE_GRAPH
using Graph = GUNDAM::Graph<
    GUNDAM::SetVertexIDType<ID>, GUNDAM::SetVertexLabelType<Label>,
    GUNDAM::SetVertexAttributeStoreType<GUNDAM::AttributeType::kGrouped>,
    GUNDAM::SetVertexAttributeKeyType<AttributeKey>, GUNDAM::SetEdgeIDType<ID>,
